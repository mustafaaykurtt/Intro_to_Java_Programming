...
public class ComputeTaxes {
	public static void main(String[] args) {
		...
		int marialStatus = input.nextInt();
		double tax = 0;
		...
		case 1: {
			...
			if (income <= 8350) {
				...
				tax = 8350 * 0.1 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28
						+ (income - 171550) * 0.28 + (income - 372950) * 0.33;

			} else {
				tax = 8350 * 0.1 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + (171550 - 82250) * 0.28
						+ (372950 - 171550) * 0.33 + (income - 372950) * 0.35;
			}
			System.out.println("tax charged to you: " + tax + " $");
		...
		case 2: {
			...
			if (income <= 16700) {
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.28 + (income - 137050) * 0.28;

			} else if (income <= 372950) {
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.28 + (208850 - 137050) * 0.28
						+ (income - 208850) * 0.33;
